...
import com.csh.mapper.ShopcarMapper;
...
public class ShopcarServiceImpl implements ShopcarService {
    ...
    public Shopcar selectUnoCarByPno(String pno, String uno) {
        return shopcarMapper.selectUnoCarByPno(pno, uno);
    }
    ...
    public boolean insertShopcar(String pno, String uno, String sno) {
        return shopcarMapper.insertShopcar(pno, uno, sno) > 0;
    }
    ...
    public boolean deleteUnoShopcarByPno(String pno, String uno) {
        return shopcarMapper.deleteUnoShopcarByPno(pno, uno) > 0;
    }
    ...
    public List<Shopcar> selectShopcarsByUno(String uno) {
        return shopcarMapper.selectShopcarsByUno(uno);
    }
